...
CREATE INDEX `recruiting_prospects_tenant_idx` ON `recruiting_prospects` (`tenantId`);
CREATE INDEX `recruiting_prospects_email_idx` ON `recruiting_prospects` (`email`);
CREATE INDEX `recruiting_prospects_status_idx` ON `recruiting_prospects` (`pipelineStatus`);
CREATE INDEX `recruiting_prospects_active_idx` ON `recruiting_prospects` (`isActive`);
CREATE INDEX `recruiting_prospects_tenant_status_idx` ON `recruiting_prospects` (`tenantId`,`pipelineStatus`);
...
CREATE INDEX `recruiting_activity_tenant_idx` ON `recruiting_pipeline_activity` (`tenantId`);
CREATE INDEX `recruiting_activity_prospect_idx` ON `recruiting_pipeline_activity` (`prospectId`);
CREATE INDEX `recruiting_activity_type_idx` ON `recruiting_pipeline_activity` (`activityType`);
CREATE INDEX `recruiting_activity_created_at_idx` ON `recruiting_pipeline_activity` (`createdAt`);
...
CREATE INDEX `import_history_tenant_idx` ON `recruiting_import_history` (`tenantId`);
CREATE INDEX `import_history_type_idx` ON `recruiting_import_history` (`importType`);
CREATE INDEX `import_history_imported_at_idx` ON `recruiting_import_history` (`importedAt`);
...
CREATE INDEX `activity_tenant_idx` ON `prospect_activity` (`tenantId`);
CREATE INDEX `activity_prospect_idx` ON `prospect_activity` (`prospectId`);
CREATE INDEX `activity_type_idx` ON `prospect_activity` (`activityType`);
CREATE INDEX `activity_created_at_idx` ON `prospect_activity` (`createdAt`);
CREATE INDEX `activity_tenant_prospect_idx` ON `prospect_activity` (`tenantId`,`prospectId`);
...
CREATE INDEX `alert_tenant_idx` ON `retention_alerts` (`tenantId`);
CREATE INDEX `alert_agent_idx` ON `retention_alerts` (`agentName`);
CREATE INDEX `alert_risk_level_idx` ON `retention_alerts` (`riskLevel`);
CREATE INDEX `alert_status_idx` ON `retention_alerts` (`alertStatus`);
CREATE INDEX `alert_tenant_status_idx` ON `retention_alerts` (`tenantId`,`alertStatus`);
